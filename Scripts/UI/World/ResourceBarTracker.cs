...
public class ResourceBarTracker : MonoBehaviour
{
    ...
    [SerializeField]
    private int resourceCurrent = 100;

    [SerializeField]
    private int resourceMax = 100;

    // [SerializeField]
    // private int resourceAbsoluteMax = 1000;

    [Space]
    [SerializeField]
    private bool overkillPossible;
    ...
    [SerializeField]
    private TMP_Text resourceValueTextField;
    ...
    [Header("Events")]
    [SerializeField]
    private UnityEvent barIsFilledUp;
    ...
    private void ConfigureBarShapeAndProperties()
    {
        ...
        {
            gameObject.GetComponent<Image>().sprite = placeholderImage;
            bar.sprite = placeholderImage;
        }
    ...
    private void SetCurrentResourceValueText()
    {
        switch (howToDisplayValueText)
        {
            ...
            case DisplayType.ShortValue:
                ...
                break;
            case DisplayType.CooldownValue:
    ...
    public bool UpdateValues(int currentValue, int maxValue)
    {
        if (isActiveAndEnabled == false)
            return false;

        if (!overkillPossible && currentValue < 0)
            return false;

        resourceCurrent = currentValue;
        resourceCurrent = Mathf.Clamp(resourceCurrent, 0, resourceMax);
    ...
    public void ChangeMaxAmountTo(int newMaxAmount)
    {
        ...
        resourceCurrent = Mathf.Clamp(resourceCurrent, 0, newMaxAmount);
    ...
    public void Setup(
        int resourceCurrent,
        int resourceMax,
        // int resourceAbsoluteMax,
        bool overkillPossible,
        ShapeType shapeOfBar,
        // AnimationSpeed animationSpeed,
        DisplayType howToDisplayValueText,
        Sprite placeholderImage
    // bool useGradient,
